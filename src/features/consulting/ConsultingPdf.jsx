...
const styles = StyleSheet.create({
  ...
  coverLogoBox: { width: 132, height: 72, padding: 8, borderRadius: 6, backgroundColor: COLORS.white },
  coverLogo: { width: '100%', height: '100%', objectFit: 'contain' },
  coverNumber: { fontSize: 10, color: '#cbd5e1', textAlign: 'right' },
  coverBody: { marginTop: 105 },
  eyebrow: { fontSize: 10, letterSpacing: 2.2, color: '#93c5fd', textTransform: 'uppercase' },
  ...
  coverClientLabel: { marginTop: 64, fontSize: 9, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 1.5 },
  coverClient: { marginTop: 8, fontSize: 19, fontFamily: 'Helvetica-Bold' },
  coverDate: { marginTop: 8, fontSize: 10, color: '#cbd5e1' },
  coverBottom: { position: 'absolute', left: 54, right: 54, bottom: 54, flexDirection: 'row', justifyContent: 'space-between' },
  coverContact: { fontSize: 8.5, color: '#cbd5e1' },
  header: {
    position: 'absolute',
    top: 24,
    left: 46,
  ...
  moduleHeader: { padding: 10, backgroundColor: COLORS.navy, flexDirection: 'row', alignItems: 'center' },
  moduleNumber: { width: 25, fontFamily: 'Helvetica-Bold', color: COLORS.amber, fontSize: 12 },
  moduleTitle: { flex: 1, color: COLORS.white, fontFamily: 'Helvetica-Bold', fontSize: 11 },
  ...
  tableHeader: { flexDirection: 'row', backgroundColor: COLORS.navy, paddingVertical: 7, paddingHorizontal: 8 },
  ...
  tableHeaderText: { color: COLORS.white, fontFamily: 'Helvetica-Bold', fontSize: 8 },
